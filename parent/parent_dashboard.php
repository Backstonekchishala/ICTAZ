        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="fas fa-user-circle"></i> Parent</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <p class="card-text">Welcome to your dashboard. Here you can view your child's results</p>
                            <div class="center-buttons">
                                <a href="view_results.php" class="btn btn-primary"><i class="fas fa-eye"></i> View Results</a>
                            </div>
                        </div>
                    </div>
                </div>
