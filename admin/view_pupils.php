...
$sql = "SELECT pupilid, userName, firstName, surname, dateOfBirth, gender, grade, address, guardianContact, examination_number FROM pupils";
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "<thead><tr><th>Username</th><th>First Name</th><th>Surname</th><th>Date of Birth</th><th>Gender</th><th>Grade</th><th>Address</th><th>Guardian Contact</th><th>Examination Number</th><th>Actions</th></tr></thead>";
                            echo "<tbody>";
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr><td>" . htmlspecialchars($row['userName']) . "</td><td>" . htmlspecialchars($row['firstName']) . "</td><td>" . htmlspecialchars($row['surname']) . "</td><td>" . htmlspecialchars($row['dateOfBirth']) . "</td><td>" . htmlspecialchars($row['gender']) . "</td><td>" . htmlspecialchars($row['grade']) . "</td><td>" . htmlspecialchars($row['address']) . "</td><td>" . htmlspecialchars($row['guardianContact']) . "</td><td>" . htmlspecialchars($row['examination_number']) . "</td>";
